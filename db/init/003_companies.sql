...
-- (SEC EDGAR, Wikidata, CareerOneStop) for ATS probing and catalog filtering.
...
CREATE TABLE companies (
    ...
    website         TEXT,
    source          TEXT NOT NULL,       -- 'sec_edgar', 'wikidata', 'careeronestop'
...
CREATE UNIQUE INDEX idx_companies_dedup ON companies (normalized_name, source);
